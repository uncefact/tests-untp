// Generated by scripts/refresh-artefacts.mjs from schema/untp/0.6.1/dcc.json. Do not edit by hand.
  ...
  $defs: {
    ...
    ConformityAttestation: {
      ...
      properties: {
        ...
        description: {
          example:
            'A life-cycle assessment of the battery  emissions intensity according to the Global Battery Alliance rule-book.',
          type: 'string',
    ...
    ConformityScheme: {
      ...
      properties: {
        ...
        description: {
          example:
            'The Sample ESG Standard provides a framework for assessing and enhancing environmental, social, and governance performance across supply chains, ensuring compliance with best practices through validated assessments.',
          type: 'string',
