// Generated by scripts/refresh-artefacts.mjs from schema/untp/0.6.1/dpp.json. Do not edit by hand.
const artefact: object = {
  ...
  properties: {
    ...
    '@context': {
      example: ['https://www.w3.org/ns/credentials/v2', 'https://test.uncefact.org/vocabulary/untp/dpp/0.6.1/'],
      type: 'array',
      items: {
        type: 'string',
      },
      ...
      default: ['https://www.w3.org/ns/credentials/v2', 'https://test.uncefact.org/vocabulary/untp/dpp/0.6.1/'],
      minItems: 2,
      uniqueItems: true,
    },
    id: {
  ...
  $defs: {
    ...
    ProductPassport: {
      ...
      description:
        'The ProductClaim class encapsulates detailed information regarding a specific product, including its identification details, manufacturer, and other pertinent details, as well as information about the claims being made about the product. ',
    },
    Product: {
      type: 'object',
      additionalProperties: true,
    ...
    Claim: {
      ...
      properties: {
        ...
        description: {
          example:
            "A standardised disclosure of the battery's greenhouse gas emissions intensity, calculated in accordance with the Global Battery Alliance Battery Passport Greenhouse Gas Rulebook V.2.0.",
          type: 'string',
    ...
    Regulation: {
      ...
      properties: {
        ...
        administeredBy: {
          ...
          required: ['id', 'name'],
          description:
            'the issuing body of the regulation. For example Australian Government Department of Climate Change, Energy, the Environment and Water',
        },
        effectiveDate: {
          example: '2024-03-20',
          type: 'string',
    ...
    Criterion: {
      ...
      properties: {
        ...
        id: {
          ...
          format: 'uri',
          description:
            'A unique identifier for the criterion within the scheme, standard  or regulation. For example CO2 emissions calculations for liquid fuel combustion.',
        },
        name: {
        ...
        performanceLevel: {
          ...
          type: 'string',
          description:
            'A performance category code to group criterion in a given hierarchyLevel according to pareformance',
        },
        category: {
          type: 'array',
          items: {
    ...
    CircularityPerformance: {
      ...
      properties: {
        type: {
          type: 'array',
          readOnly: true,
          default: ['CircularityPerformance'],
          items: {
            type: 'string',
          },
          allOf: [
