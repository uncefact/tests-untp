// Generated by scripts/refresh-artefacts.mjs from schema/untp/0.6.0/dte.json. Do not edit by hand.
const artefact: object = {
  ...
  properties: {
    ...
    '@context': {
      example: ['https://www.w3.org/ns/credentials/v2', 'https://test.uncefact.org/vocabulary/untp/dte/0.6.0/'],
      type: 'array',
      items: {
        type: 'string',
      },
      ...
      default: ['https://www.w3.org/ns/credentials/v2', 'https://test.uncefact.org/vocabulary/untp/dte/0.6.0/'],
      minItems: 2,
      uniqueItems: true,
    },
    issuer: {
