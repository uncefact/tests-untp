// Generated by scripts/refresh-artefacts.mjs from schema/untp/0.6.0/dfr.json. Do not edit by hand.
const artefact: object = {
  ...
  properties: {
    ...
    '@context': {
      example: ['https://www.w3.org/ns/credentials/v2', 'https://test.uncefact.org/vocabulary/untp/dfr/0.6.0/'],
      type: 'array',
      items: {
        type: 'string',
      },
      ...
      default: ['https://www.w3.org/ns/credentials/v2', 'https://test.uncefact.org/vocabulary/untp/dfr/0.6.0/'],
      minItems: 2,
      uniqueItems: true,
    },
    id: {
    ...
    Facility: {
      ...
      properties: {
        ...
        operatedByParty: {
          ...
          required: ['id', 'name'],
          description:
            'The Party entity responsible for operating the facility.An object structure that uniquely identifies the party within a known party identification scheme. ',
        },
        facilityAlsoKnownAs: {
          type: 'array',
          items: {
