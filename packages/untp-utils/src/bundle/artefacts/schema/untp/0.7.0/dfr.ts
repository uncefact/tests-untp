// Generated by scripts/refresh-artefacts.mjs from schema/untp/0.7.0/dfr.json. Do not edit by hand.
const artefact: object = {
  ...
  $defs: {
    ...
    Facility: {
      ...
      required: ['id', 'name', 'countryOfOperation', 'processCategory', 'locationInformation', 'address'],
    },
    Country: {
      type: 'object',
      additionalProperties: false,
