// Generated by scripts/refresh-artefacts.mjs from schema/untp/0.7.0/cvc.json. Do not edit by hand.
const artefact: object = {
  ...
  properties: {
    '@context': {
      example: ['https://vocabulary.uncefact.org/untp/0.7.0/context/'],
      type: 'array',
      items: {
        type: 'string',
      },
      description:
        'A list of JSON-LD context URIs that define the semantic meaning of properties within this conformity scheme document.',
      readOnly: true,
      prefixItems: [
        {
      ...
      default: ['https://vocabulary.uncefact.org/untp/0.7.0/context/'],
      minItems: 1,
      uniqueItems: true,
    },
    type: {
    ...
    endorsementLevel: {
      type: 'string',
      enum: ['endorsed_self', 'endorsed_mandate', 'endorsed_accreditation', 'endorsed_benchmarked'],
    ...
    endorsement: {
      ...
      description:
        'The endorsement provided to the scheme by an external authority such as a regulator, an accreditaiton authority, or a benchmarking scheme.',
    },
    schemeScoringFramework: {
      $ref: '#/$defs/ScoringFramework',
      description:
        'The scheme level overall scoring framework that represents the achievement levels (AA, A, B etc) that maybe be awarded to the subject of an independent assessment under the scheme.',
    },
    documentation: {
      type: 'string',
      format: 'uri',
    ...
    geographicScope: {
      ...
      description:
        'The geographic scope of this scheme as a list of ISO-3166 countries, regions, or code=001, name=Worldwide to indicate global coverage.',
    },
    industryScope: {
      type: 'array',
      items: {
    ...
    conformsTo: {
      ...
      required: ['linkName', 'linkURL'],
      description:
        'The name and URI of the vocabulary standard (eg UNTP CVC) that the machine readable version of this sceme conforms to.',
    },
    includedProfile: {
      type: 'array',
      items: {
  ...
  required: ['@context', 'id', 'name', 'owner', 'endorsementLevel', 'documentation'],
  $defs: {
    Endorsement: {
      type: 'object',
      additionalProperties: true,
    ...
    Image: {
      ...
      description:
        'A binary image encoded as base64 text and embedded into the data.  Use this for small images like certification trust marks or regulated labels.  Large images should be external links.',
    ...
    ConformityProfile: {
      ...
      properties: {
        ...
        subjectType: {
          type: 'string',
          enum: ['product', 'facility', 'organisation'],
          example: 'product',
          description:
            'The type of the subject of assessments made under this conformity profile (eg product, facility, organisation)',
        },
        standardAlignment: {
          type: 'array',
          items: {
          ...
          description:
            'A list of voluntary standards referenced by this conformity profile and against which some level of compliance can be inferred for subjects that pass an assessment.  ',
        },
        regulatoryAlignment: {
          type: 'array',
          items: {
          ...
          description:
            'A list of regulations or legally binding conventions referenced by this conformity profile and against which some level of compliance can be inferred for subjects that pass an assessment.  ',
        },
        ...
        scope: {
          ...
          description:
            'A set of classification codes that may be used to categorize the applicability of this criteria - for example industry sector, jurisdiction or commodity type - based on a formal vocabulary.',
        },
        scheme: {
          type: 'object',
          properties: {
      ...
      required: ['id', 'name', 'version', 'validFrom', 'status', 'criterion', 'scheme'],
    },
    StandardAlignment: {
      type: 'object',
      additionalProperties: false,
    ...
    Criterion: {
      ...
      properties: {
        ...
        version: {
          type: 'string',
          description:
            'The major.minor version of the criterion. Minor versions represent changes that would not invalidate an assessment made under a previous version.',
        },
        status: {
          type: 'string',
          enum: ['proposed', 'active', 'deprecated'],
        ...
        tag: {
          ...
          description:
            'A set of tags that can be used by the scheme owner to be able to filter or group criterion in a large vocabulary for specific use cases.',
        },
        requiredPerformance: {
          type: 'array',
          items: {
          ...
          description:
            'The required performance level as one or more score and/or a metric that represents compliance defined by the criteria',
        },
      },
      description:
      ...
      required: ['id', 'name', 'version', 'status', 'conformityTopic', 'requiredPerformance'],
    },
    ConformityTopic: {
      type: 'object',
      additionalProperties: false,
