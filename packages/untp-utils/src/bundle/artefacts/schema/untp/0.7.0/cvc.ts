...
const artefact: object = {
  ...
  "properties": {
    "@context": {
      ...
      "description": "A list of JSON-LD context URIs that define the semantic meaning of properties within this conformity scheme document.",
      "readOnly": true,
      "prefixItems": [
        {
  ...
  "$defs": {
    ...
    "Criterion": {
      ...
      "properties": {
        ...
        "version": {
          "type": "string",
          "description": "The major.minor version of the criterion. Minor versions represent changes that would not invalidate an assessment made under a previous version."
        },
        "status": {
          "type": "string",
          "enum": ["proposed", "active", "deprecated"],
        ...
        "requiredPerformance": {
          ...
          "description": "The required performance level as one or more score and/or a metric that represents compliance defined by the criteria"
        }
      },
