    ...
    Product: {
      ...
      properties: {
        ...
        expiryDate: {
          ...
          format: 'date',
          description:
            'The date at which this product is no longer fit for use. Typically used for a food product use-by date but may also represent the usable life of any product.',
        },
        countryOfProduction: {
          $ref: '#/$defs/Country',
