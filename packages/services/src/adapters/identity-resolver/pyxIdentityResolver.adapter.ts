...
import type { AdapterConstructorOptions, Logger } from '../../registry/adapter-options.js';
import { createPrefixedLogger } from '../../registry/adapter-options.js';
import { pyxIdrConfigSchema, type PyxIdrConfig } from '../../identity-resolver/adapters/pyx/pyx-idr.schema.js';
import type {
...
export class PyxIdentityResolverAdapter implements IIdentityResolverService {
  ...
  constructor(config: PyxIdrConfig, options: AdapterConstructorOptions) {
    ...
    this.logger = createPrefixedLogger(options);
  }
...
export const pyxIdrRegistryEntry = {
  ...
  factory: (config: PyxIdrConfig, options: AdapterConstructorOptions): IIdentityResolverService =>
    new PyxIdentityResolverAdapter(config, options),
