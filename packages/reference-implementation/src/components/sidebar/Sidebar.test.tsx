...
describe('Sidebar', () => {
  ...
  it('calls onNavClick when credential sub-item is clicked', async () => {
    ...
    render(<Sidebar {...defaultProps} onNavClick={handleNavClick} selectedNavId='credentials' />);
  ...
  it('collapses credentials when clicking a non-expandable item with autoCollapseInactive', async () => {
    const user = userEvent.setup();
    render(<Sidebar {...defaultProps} selectedNavId='conformity-credential' autoCollapseInactive={true} />);
