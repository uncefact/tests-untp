...
describe('generateCredentialFile', () => {
  ...
  it('should generate latest credential file successfully', async () => {
    ...
    const credentialFileData = await credentials.generateCredentialFile(storePath, schemasPath);
  ...
  it('should throw an error when invalid store path', async () => {
    try {
      ...
      await credentials.generateCredentialFile(invalidStorePath, schemasPath);
    } catch (error) {
  ...
  it('should throw an error when invalid schemas path', async () => {
    try {
      ...
      await credentials.generateCredentialFile(storePath, invalidSchemasPath);
    } catch (error) {
