...
describe('Render DTE Aggregation Event end-to-end testing flow', () => {
  describe('Issue DTE Aggregation Event', () => {
    beforeEach(() => {
      traceabilityIssue.beforeAll();
    });

    it('should issue DTE Aggregation Event', () => {
  ...
  describe('should render DTE Aggregation Event', () => {
    beforeEach(() => {
