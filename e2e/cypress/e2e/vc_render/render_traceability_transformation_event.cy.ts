...
describe('Render DTE Transformation Event end-to-end testing flow', () => {
  describe('Issue DTE Transformation Event', () => {
    beforeEach(() => {
      traceabilityIssue.beforeAll();
    });

    it('should issue DTE Transformation Event', () => {
  ...
  describe('should render DTE Transformation Event', () => {
    beforeEach(() => {
