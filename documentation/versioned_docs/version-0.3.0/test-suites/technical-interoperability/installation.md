...
Before you begin installing the Tier 1 test suite, ensure that you have the [dependant services](/docs/reference-implementation/services/service-architecture) and the following prerequisites in place:
