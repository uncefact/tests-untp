...
Before you begin installing the Tier 1 test suite, ensure that you have the [dependant services](/docs/0.1.0/reference-implementation/dependent-services/) and the following prerequisites in place:
