...
| epcisTransformationEvent      | Yes      | Configuration for the EPCIS Transformation Event                                                                                    | [Credential](/docs/reference-implementation/common/credential)                 |
...
| dpp                           | Yes      | Configuration for the Digital Product Passport                                                                                      | [Credential](/docs/reference-implementation/common/credential)                 |
| dppCredentials                | Yes      | Mapping configuration for DPP credentials                                                                                           | [Construct Data](/docs/reference-implementation/common/construct-data)[]       |
...
| transformationEventCredential | Yes      | Mapping and generation configuration for the transformation event credential                                                        | [Construct Data](/docs/reference-implementation/common/construct-data)         |
