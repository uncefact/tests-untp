...
| traceabilityEvent | Yes      | Configuration for the EPCIS Transformation Event Event                                                                                   | [Credential](/docs/0.1.0/reference-implementation/common/credential)                 |
...
| identifierKeyPath | Yes      | JSON path to the identifier in the credential subject or the association for function and arguments of JSON path to construct identifier | [IdentifierKeyPath](/docs/0.1.0/reference-implementation/common/identifier-key-path) |
