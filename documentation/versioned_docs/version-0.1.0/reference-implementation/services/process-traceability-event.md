...
| traceabilityEvent | Yes      | Configuration for the EPCIS Traceability Event Event                                                                                | [Credential](/docs/0.1.0/reference-implementation/common/credential)                 |
