...
| props    | Yes      | The properties for the QRCodeScannerDialogButton                 | [Props](/docs/0.1.0/reference-implementation/components/qr-code-scanner-dialog-button#props) |

### Props

| Property  | Required | Description                                                                                           | Type                                                                            |
| --------- | -------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| style     | No       | The style for the component                                                                           | [Style](/docs/0.1.0/reference-implementation/common/style)                                           |
| type      | No       | The type of data (should be 'VerifiableCredential' and 'JSON'), the default is 'VerifiableCredential' | [PayloadType](/docs/0.1.0/reference-implementation/common/payload-type)                              |
| vcOptions | No       | The options for the VC data processing                                                                | [VC component configuration](/docs/0.1.0/reference-implementation/configuration/vc-component-config) |
