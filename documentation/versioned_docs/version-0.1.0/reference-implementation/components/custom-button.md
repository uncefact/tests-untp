...
| type | Yes | The type of the button (should be "Submit")| [ComponentType](/docs/0.1.0/reference-implementation/common/component-type) |
| props | Yes | The properties for the CustomButton | [Props](/docs/0.1.0/reference-implementation/components/custom-button#props) |
