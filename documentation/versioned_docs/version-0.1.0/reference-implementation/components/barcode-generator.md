...
| type     | Yes      | The type of the component (should be "Result")           | [ComponentType](/docs/0.1.0/reference-implementation/common/component-type)      |
| props    | Yes      | The properties for the BarcodeGenerator                  | [Props](/docs/0.1.0/reference-implementation/components/barcode-generator#props) |
...
| dataPath | Yes      | A JSON pointer path to extract barcode data from the credential object                            | [AIData](/docs/0.1.0/reference-implementation/common/construct-ai-data) |
