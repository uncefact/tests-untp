...
| ----------------- | :------: | --------------------------------------- | ------------------------------------------------------------ |
| identifierKeyPath |   Yes    | The path to extract the identifier data | String or [AIData](/docs/0.1.0/reference-implementation/common/construct-ai-data) |
