...
| ---------- | :------: | ---------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| primary    |   Yes    | The primary AI that defines the AI code and the path for primary AI value          | [AI config](/docs/0.1.0/reference-implementation/common/construct-ai-data#ai-config)   |
| qualifiers |    No    | The list of qualifiers that define the AI code and the path for qualifier AI value | [AI config](/docs/0.1.0/reference-implementation/common/construct-ai-data#ai-config)[] |
