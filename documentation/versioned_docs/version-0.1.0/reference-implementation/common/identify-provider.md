...
The `Identify Provider` object is a key component in the Reference implementation system that links scanned identifiers to their corresponding [Identity Resolver Service](/docs/0.1.0/reference-implementation/dependent-services/identity-resolution-service), understands how to communicate with such services and encapsulates logic to interpret data retrieved from data carriers.
...
| --------- | :------: | ------------------------------------------------------------- | ----------------------------------------------------------------------- |
| type      |   Yes    | The type of identify provider, e.g., "gs1" for GS1 standards. | [ProviderType](/docs/0.1.0/reference-implementation/common/identify-provider#provider-types) |
