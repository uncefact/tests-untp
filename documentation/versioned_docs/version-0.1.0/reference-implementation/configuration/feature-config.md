...
| components | Yes      | A collection of components used in the feature | [Component](/docs/0.1.0/reference-implementation/configuration/component-config)[]  |
| services   | Yes      | A collection of services used in the feature   | [Service](/docs/0.1.0/reference-implementation/configuration/service-config)[]  |
