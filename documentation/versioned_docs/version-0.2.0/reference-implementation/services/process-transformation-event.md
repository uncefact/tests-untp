...
| epcisTransformationEvent      | Yes      | Configuration for the EPCIS Transformation Event                                                                                    | [Credential](/docs/0.2.0/reference-implementation/common/credential)                 |
...
| dpp                           | Yes      | Configuration for the Digital Product Passport                                                                                      | [Credential](/docs/0.2.0/reference-implementation/common/credential)                 |
| dppCredentials                | Yes      | Mapping configuration for DPP credentials                                                                                           | [Construct Data](/docs/0.2.0/reference-implementation/common/construct-data)[]       |
...
| transformationEventCredential | Yes      | Mapping and generation configuration for the transformation event credential                                                        | [Construct Data](/docs/0.2.0/reference-implementation/common/construct-data)         |
