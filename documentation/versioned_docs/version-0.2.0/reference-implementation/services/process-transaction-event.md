...
| traceabilityEvent  | Yes      | Configuration for the EPCIS Transaction Event                                                                                       | [Credential](/docs/0.2.0/reference-implementation/common/credential)                 |
...
| localStorageParams | Yes      | Configuration for local storage management                                                                                          | [LocalStorage](/docs/0.2.0/reference-implementation/common/local-storage)            |
