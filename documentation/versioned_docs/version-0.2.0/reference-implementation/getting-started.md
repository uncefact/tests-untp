...
1. [**Installing Dependencies**](/docs/reference-implementation/installation): Learn how to install the necessary dependencies required to run the mock apps.
...
3. [**Mock App Configuration File**](/docs/reference-implementation/configuration/): Get acquainted with the mock app configuration file. We will provide an overview of the configuration options available and guide you on how to customise the mock apps to suit your specific requirements.
