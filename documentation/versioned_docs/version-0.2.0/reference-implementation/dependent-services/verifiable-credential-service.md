...
If you've chosen to use the Docker Compose setup as described in the [Dependent Services](/docs/0.2.0/reference-implementation/dependent-services/) section, most of the configuration is already done for you. In this case, you only need to:
