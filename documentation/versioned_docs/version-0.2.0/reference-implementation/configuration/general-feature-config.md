...
| style | Yes | Custom styling options for the general feature (Used to determine the colour of the header and buttons on the general feature page)| [Style](/docs/0.2.0/reference-implementation/common/style) |
| features | Yes | A collection of features that make up this general feature | [Feature](/docs/0.2.0/reference-implementation/configuration/feature-config)[] |
