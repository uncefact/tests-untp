...
Apps are composed of features which have ids and names to be able to discern between features within the UI of the respective app and the entry point of each feature (button) is displayed on the home page of the respective app just as the [general features](/docs/0.2.0/reference-implementation/configuration/general-feature-config).
...
| assets   | Yes      | Assets associated with the app                      | [Asset](/docs/0.2.0/reference-implementation/common/asset) |
| styles   | Yes      | Styling information for the app                     | [Style](/docs/0.2.0/reference-implementation/common/style) |
| features | Yes      | Array of features available in the app              | [Feature](/docs/0.2.0/reference-implementation/configuration/feature-config)[]  |
