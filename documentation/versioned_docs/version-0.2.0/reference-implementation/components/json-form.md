...
| props | Yes | The properties for the JsonForm component | [Props](/docs/0.2.0/reference-implementation/components/json-form#props) |
...
| constructData | No | Defines the schema for constructing event data, including field mappings, default values, and data generation rules. | [ConstructData](/docs/0.2.0/reference-implementation/common/construct-data) |
