...
| type     | Yes      | The type of the component (should be "Void")                 | [ComponentType](/docs/0.2.0/reference-implementation/common/component-type)          |
| props    | Yes      | The properties for the ConformityCredential                  | [Props](/docs/0.2.0/reference-implementation/components/conformity-credential#props) |

### Props

| Property                 | Required | Description                                   | Type                                                                                                  |
| ------------------------ | -------- | --------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| credentialRequestConfigs | Yes      | An array of credential request configurations | [CredentialRequestConfig[]](/docs/0.2.0/reference-implementation/components/conformity-credential#credentialrequestconfig) |
| storedCredentialsConfig  | Yes      | Configuration for storing credentials         | [Storage](/docs/0.2.0/reference-implementation/common/storage)                                                             |
...
| options        | Yes      | Request options                                      | [RequestOptions](/docs/0.2.0/reference-implementation/components/conformity-credential#requestoptions) |
