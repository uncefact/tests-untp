...
| **HTTPS**            | Confirms the DID document was served over HTTPS. Checks the final URL after any redirects; the check fails if a redirect lands on an insecure connection or if resolution does not complete, leaving no final URL to inspect.                                                                                                                                                                                                                                                                                               |
...
| `isDefault`         | Whether this DID is marked as the tenant's default signing identity for display and selection. Credential issuance always names `issuer.id` explicitly                                                                                                                                                                    |
...
| `isDefault`     | Whether to mark this DID as the tenant's default signing identity for display and selection. Credential issuance always names `issuer.id` explicitly. Cannot be changed on system default DIDs |
