...
The following fields have been moved from the `Product` level to the `ProductPassport` level 'granularityLevel', 'dueDiligenceDeclaration', 'materialsProvenance', 'circularityScorecard', 'emissionsScorecard', 'traceabilityInformation'
