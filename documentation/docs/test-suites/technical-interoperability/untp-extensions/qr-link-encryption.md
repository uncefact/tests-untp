...
For detailed information about the Verify Link structure and usage, please refer to the [Verify Link documentation](/docs/reference-implementation/verify-page).
