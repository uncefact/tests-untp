...
Configuration URL checks reject private or reserved destinations unless `FETCH_ALLOW_PRIVATE_URLS` is set to exact lowercase `true`; see [Credential Fetch Settings](../operations/startup#credential-fetch-settings).
